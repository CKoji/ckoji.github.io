...
export default function App() {
  ...
  const [numPours, setNumPours] = useState<number>(3);
  ...
  const handlePoursChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
      ...
      <div className="mt-8 w-full max-w-md bg-white rounded-2xl shadow-lg overflow-hidden border border-amber-200/50">
          <div className="p-6 sm:p-8 space-y-6">
              ...
              <div className="space-y-4">
                  <h2 className="text-lg font-semibold text-gray-700 border-b pb-2">Brew Settings</h2>
